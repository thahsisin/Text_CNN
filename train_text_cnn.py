...
#tf.flags.DEFINE_float("dev_sample_percentage", .1, "Percentage of the training data to use for validation")
tf.flags.DEFINE_string("input_file", "input_file.csv", "input data file")
...
# Load data
print("Loading data...")
x_text, y = data_helpers.load_data_and_labels(FLAGS.input_file)
...
print(FLAGS.dev_sample_percentage * float(len(y)))
